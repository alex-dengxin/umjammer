 ...
 * 
 * 
 * Class: GCookiesListener @author olivier gäumann, neuchâtel (switzerland) @target JDK 1.3
 * 
 * cookies interface.
 * 
 ...
 * 
 */
public interface GCookiesListener {
    /**
     * returns the named cookie if existing, or null.
     */
    public GCookie getCookie(String name);

    /**
     * set a new cookie, identified by name
     */
