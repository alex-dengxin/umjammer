 ...
 * 
 * 
 * Class: ASavePcmUnsigned16BitBigEndian @author olivier gäumann, neuchâtel (switzerland) @target JDK 1.3
 * 
 ...
 * 
 */
public class ASavePcmUnsigned16BitBigEndian extends ASave {
    /**
     * constructor
     */
    public ASavePcmUnsigned16BitBigEndian() {
        samplePtr = 0;
        channelPtr = 0;
        bytePtr = 0;
    }
    ...
    public ASave duplicate() {
        return new ASavePcmUnsigned16BitBigEndian();
    }
