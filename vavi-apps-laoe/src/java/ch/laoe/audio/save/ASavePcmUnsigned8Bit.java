 ...
 * 
 * 
 * Class: ASavePcmUnsigned8Bit @author olivier gäumann, neuchâtel (switzerland) @target JDK 1.3
 * 
 * PCM unsigned 8bit file saver
 * 
 * @version 27.11.00 new stream-technique oli4
 * 
 */
public class ASavePcmUnsigned8Bit extends ASave {
    /**
     * constructor
     */
    public ASavePcmUnsigned8Bit() {
        super();
        samplePtr = 0;
        channelPtr = 0;
        bytePtr = 0;
