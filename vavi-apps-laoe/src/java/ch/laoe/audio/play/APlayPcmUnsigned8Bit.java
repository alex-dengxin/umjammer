 ...
 * 
 * 
 * Class: APlayPcmUnsigned8Bit @author olivier gäumann, neuchâtel (switzerland) @target JDK 1.3
 * 
 * PCM unsigned 8bit player
 * 
 * @version 27.11.00 new stream-technique oli4
 * 
 */
public class APlayPcmUnsigned8Bit extends APlay {
    /**
     * constructor
     */
