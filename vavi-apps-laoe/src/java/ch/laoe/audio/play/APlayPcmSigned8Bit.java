 ...
 * 
 * 
 * Class: APlayPcmSigned8Bit @author olivier gäumann, neuchâtel (switzerland) @target JDK 1.3
 * 
 * PCM signed 8bit player
 * 
 * @version 27.11.00 new stream-technique oli4
 * 
 */
public class APlayPcmSigned8Bit extends APlay {
    /**
     * constructor
     */
    public APlayPcmSigned8Bit() {
        dataBufferLength = 4000;
