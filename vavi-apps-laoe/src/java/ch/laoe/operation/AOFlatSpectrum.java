 ...
 * 
 * 
 * Class: AOFlatSpectrum @author olivier gäumann, neuchâtel (switzerland) @target JDK 1.3
 * 
 * generate a neutral flat spectrum
 * 
 * @version 28.12.01 first draft oli4
 * 
 */
public class AOFlatSpectrum extends AOperation {
    /**
     * constructor
     */
    public AOFlatSpectrum() {
        super();
    }
