...
import com.strangeberry.jmdns.JmDNS;
import com.strangeberry.jmdns.ServiceEvent;
import com.strangeberry.jmdns.ServiceInfo;
import com.strangeberry.jmdns.ServiceListener;
import com.strangeberry.jmdns.ServiceTypeListener;
 ...
 * @version %I%, %G%
 */
public class Browser extends JFrame implements ServiceTypeListener, ListSelectionListener {
    JmDNS jmdns;
    ...
    private ServiceListener serviceListener = new ServiceListener() {
        ...
        public void serviceResolved(ServiceEvent event) {
            ...
            if (name.equals(serviceList.getSelectedValue())) {
                if (info == null) {
                    Browser.this.info.setText("service not found");
                } else {
                    ...
                    Browser.this.info.setText(buf.toString());
                }
            }
        }
    };
