 ...
 * See {@link AlertType#playSound(vavi.microedition.lcdui.Display) 
...
// *****************************************************
    ...
    void callShowNotify(Display d) {
        ...
        if (timeout == FOREVER) {
            ...
            timeoutTimer.setListener(timerTask); // 0
            timeoutTimer.setTime(timeout); // TODO loop ?
        }
...
// *****************************************************
     ...
     */
    private TimerListener timerTask;
...
// *****************************************************
     ...
     */
    class timeoutTask implements TimerListener { // TODO
