...
public class Graphics extends com.nttdocomo.ui.Graphics {
...
//      init();
     ...
     * @return current font
     * @see vavi.microedition.lcdui.Font
     * @see #setFont(vavi.microedition.lcdui.Font)
     */
    public Font getFont() {
        return currentFont;
    }
    ...
    public void drawRoundRect(int x, int y, int width, int height,
        ...
        super.drawRect(x, y, width, height); // TODO arc
    }
    ...
    public void fillRoundRect(int x, int y, int width, int height,
                                     int arcWidth, int arcHeight) {
        super.fillRect(x, y, width, height); // TODO arc
    }
    ...
    public void drawString(java.lang.String str,
        ...
        super.drawString(str, x, y); // TODO ancher
    }
    ...
    public void drawSubstring(String str, int offset, int len,
                                     int x, int y, int anchor) {
        super.drawString(str.substring(offset, len + offset), x, y); // TODO ancher
    }
    ...
    public void drawChar(char character, int x, int y, int anchor) {
        super.drawChars(new char[] { character }, x, y, 0, 1); // TODO ancher
    }
    ...
    public void drawChars(char[] data, int offset, int length,
                                 int x, int y, int anchor) {
        super.drawChars(data, x, y, offset, length); // TODO ancher
    }
    ...
    public void drawImage(Image img, int x, int y, int anchor) {
        super.drawImage(img, x, y); // TODO ancher
    }
    ...
    private void doCopyArea(int x_src, int y_src, 
                            int width, int height, 
                            int x_dest, int y_dest, int anchor) {
        super.copyArea(x_src, y_src, width, height, x_dest, y_dest); // TODO ancher
    }
     ...
     * format with <code>24</code> bits of RGB and an eight-bit alpha value (<code>0xAARRGGBB</code>),
     * with the first value stored at the specified offset. The
     * <code>scanlength</code> specifies the relative offset within the array
     * between the corresponding pixels of consecutive rows. Any value for
     * <code>scanlength</code> is acceptable (even negative values) provided
     * that all resulting references are within the bounds of the
     * <code>rgbData</code> array. The ARGB data is rasterized horizontally
     * from left to right within each row. The ARGB values are rendered in the
     * region specified by <code>x</code>, <code>y</code>,
     ...
     * </TABLE>
     * <p>
     * This capability is provided in the <code>Graphics</code> class so that
     * it can be used to render both to the screen and to offscreen
     * <code>Image</code> objects. The ability to retrieve ARGB values is
     * provided by the {@link Image#getRGB} method.
     * </p>
     * 
     * <p>
     * If <code>processAlpha</code> is <code>true</code>, the high-order
     * byte of the ARGB format specifies opacity; that is,
     * <code>0x00RRGGBB</code> specifies a fully transparent pixel and
     * <code>0xFFRRGGBB</code> specifies a fully opaque pixel. Intermediate
     * alpha values specify semitransparency. If the implementation does not
     * support alpha blending for image rendering operations, it must remove any
     * semitransparency from the source data prior to performing any rendering.
     * (See <a href="Image.html#alpha">Alpha Processing</a> for further
     * discussion.) If <code>processAlpha</code> is <code>false</code>, the
     * alpha values are ignored and all pixels must be treated as completely
     * opaque.
     * </p>
     * 
     * <p>
     ...
     *            pixels in consecutive rows in the <code>rgbData</code> array
     ...
     * @param processAlpha <code>true</code> if <code>rgbData</code> has an
     *            alpha channel, false if all pixels are fully opaque
     * 
     * @throws ArrayIndexOutOfBoundsException if the requested operation will
     *             attempt to access an element of <code>rgbData</code> whose
     *             index is either negative or beyond its length
     * @throws NullPointerException if <code>rgbData</code> is
     *             <code>null</code>
     * 
     * @since MIDP 2.0
     */
