...
/**
 * a GUI component to choose one layer from any open clip.
 * 
 * @author olivier gäumann, neuchâtel (switzerland)
 * @target JDK 1.3
 * 
 * @version 25.10.00 erster Entwurf oli4 
 */
public class GClipLayerChooser extends JPanel implements ActionListener {
    public GClipLayerChooser(GMain m) {
        main = m;
        initGui("layer");
    }

    public GClipLayerChooser(GMain m, String title) {
        main = m;
        initGui(title);
    }
