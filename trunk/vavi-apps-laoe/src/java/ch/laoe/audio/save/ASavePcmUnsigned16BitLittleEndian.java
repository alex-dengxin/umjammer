 ...
 * 
 * 
 * Class: ASavePcmUnsigned16BitLittleEndian @author olivier gäumann, neuchâtel (switzerland) @target JDK 1.3
 * 
 ...
 * 
 */
public class ASavePcmUnsigned16BitLittleEndian extends ASave {
    /**
     * constructor
     */
    public ASavePcmUnsigned16BitLittleEndian() {
        samplePtr = 0;
        channelPtr = 0;
        bytePtr = 0;
    }
