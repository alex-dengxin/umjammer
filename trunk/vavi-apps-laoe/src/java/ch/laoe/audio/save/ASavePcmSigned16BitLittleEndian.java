 ...
 * 
 * 
 * Class: ASavePcmSigned16BitLittleEndian @author olivier gäumann, neuchâtel (switzerland) @target JDK 1.3
 * 
 ...
 * 
 */
public class ASavePcmSigned16BitLittleEndian extends ASave {
    /**
     * constructor
     */
    public ASavePcmSigned16BitLittleEndian() {
        samplePtr = 0;
        channelPtr = 0;
        bytePtr = 0;
    }
    ...
    public ASave duplicate() {
        return new ASavePcmSigned16BitLittleEndian();
    }
