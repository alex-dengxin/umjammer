...
/**
 * PCM unsigned 16bit little endian file loader
 * 
 ...
 */
public class ACapturePcmUnsigned16BitLittleEndian extends ACapture {
    /**
     * constructor
     */
    public ACapturePcmUnsigned16BitLittleEndian() {
        super();
    }

    public ACapture duplicate() {
        return new ACapturePcmUnsigned16BitLittleEndian();
    }
