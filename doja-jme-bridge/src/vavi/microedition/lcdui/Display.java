...
import vavi.microedition.midlet.MIDlet;

import vavi.microedition.lcdui.game.GameCanvas;
import vavi.microedition.lcdui.game.GameMap;

import vavi.microedition.midlet.MIDletEventListener;
import vavi.microedition.midlet.MIDletState;
import vavi.microedition.midlet.MIDletStateMap;
import vavi.microedition.midlet.MIDletSuite;
import vavi.microedition.midlet.Scheduler;
 ...
 * vavi.microedition.midlet.MIDlet MIDlet} and the application can get a
 * reference to that instance by calling the {@link
 * #getDisplay(vavi.microedition.midlet.MIDlet) getDisplay()} method. The
 ...
 */
    ...
    private static final Graphics screenGraphics = Graphics.getGraphics(null);
 ...
 */
     ...
     */
    private void drawTrustedIcon(boolean drawTrusted) {
        // TODO implement
System.err.println("trusted: " + drawTrusted);
    }
...
class DeviceCaps {
    ...
    private void init() {
        ...
        numAlphaLevels = 256;
        keyCodeUp = com.nttdocomo.ui.Display.KEY_UP;
        keyCodeDown = com.nttdocomo.ui.Display.KEY_DOWN;
        keyCodeLeft = com.nttdocomo.ui.Display.KEY_LEFT;
        keyCodeRight = com.nttdocomo.ui.Display.KEY_RIGHT;
        keyCodeSelect = com.nttdocomo.ui.Display.KEY_SELECT;
    }
}
