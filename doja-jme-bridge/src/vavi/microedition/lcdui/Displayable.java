...
// ************************************************************
    ...
    private final static Timer tickerTimer = new Timer();
...
// ************************************************************
    ...
    private void startTicker() {
        ...
        tickerTimer.setListener(tickerPainter);
        tickerTimer.setTime((int) Ticker.TICK_RATE);
    }
...
// ************************************************************
     ...
     * if one has been set
     */
    private class TickerPainter implements TimerListener {
        /**
