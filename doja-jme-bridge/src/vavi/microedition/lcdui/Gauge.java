...
public class Gauge extends Item {
     ...
     */
    private class GaugeUpdateTask implements TimerListener {
	/**
	...
	gaugeUpdateTimer.setListener(updateHelper);
	gaugeUpdateTimer.setTime(250); // 250
    }
